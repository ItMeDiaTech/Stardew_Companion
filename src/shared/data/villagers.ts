...
export const VILLAGERS: Villager[] = [
  ...
  },
  {
    ...
    dislikedGifts: [
      'All Universal Dislikes (except Dragon Tooth, Sea Urchin)',
  ...
  },
  {
    ...
    dislikedGifts: [
      ...
      'All Cooking (except Baked Fish, Carp Surprise, Chowder, Crab Cakes, Crispy Bass, Escargot, Fish Stew, Fish Taco, Fried Calamari, Fried Eel, Lobster Bisque, Salmon Dinner, Seafoam Pudding, Trout Soup, Bread, Strange Bun)',
      'Chanterelle',
      'Common Mushroom',
      'Daffodil',
      'Dandelion',
  ...
  },
  {
    ...
    dislikedGifts: [
      'All Universal Dislikes (except Geode Minerals, Iridium Bar, Solar Essence, Super Cucumber, Trinkets, Void Essence)',
      'All Eggs',
      'All Milk',
      'Chanterelle',
      'Common Mushroom',
